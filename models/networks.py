...
####################################
def define_ResUnet_TFM(input_nc=9, output_nc=4, num_downs=6, ngf=32, norm='batch', use_dropout=False, init_type='normal', init_gain=0.02, gpu_ids=[]):
    norm_layer = get_norm_layer(norm_type=norm)
    
    #ipdb.set_trace()
    print("Using ResUnet generator...")
    net = ResUnetGenerator(input_nc, output_nc, num_downs, ngf, norm_layer, use_dropout)
